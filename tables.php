        ...
        <div class="col-12">
          <div class="card mb-4 rounded-1 shadow-lg bottom-color">
            <div class="card-header pb-0">
              <h6 class="text-success">Customer table</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0 text-font">
                <table class="table align-items-center mb-0" id="getCustID">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        $userstmt = "SELECT c.customersID, c.firstname, c.lastname,c.gender,c.birthday,c.phoneNo,u.email from customers c inner join  userc u on c.userID=u.userID";
                        $stmtrslt = mysqli_query($conn,$userstmt);

                          while($row=mysqli_fetch_assoc($stmtrslt)){?>
                            <td class="d-flex flex-column justify-content-center"><p class="text-xs text-secondary mb-0"><?php echo $row['customersID'];?></p></td>
                            <td><h6 class="mb-0 text-sm"><?php echo $row['firstname'];?></h6></td>
                            <td><h6 class="mb-0 text-sm"><?php echo $row['lastname'];?></h6></td>
                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['gender'];?></span></td>
                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['birthday'];?></span></td>
                            ...
                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><a href="billing.php?a=<?php echo $row['customersID'];?>">view</span></td>
                    </tr>
                    <?php
                          }
                    ?>
